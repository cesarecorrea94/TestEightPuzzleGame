...
public class Test_GenerateListOfTiles_AllCUses_SomePUses {
	...
	@Test
	public void generateListOfTiles_listOfTiles_nodoPosInitialize_nodoReturn() {
		this.delegatedTest(0);
	}

	@Test
	public void generateListOfTiles_listOfTiles_nodoInLoop_nodoInLoop() {
		this.delegatedTest(2);
	}

	@Test
	public void generateListOfTiles_listOfTiles_nodoInLoop_nodoReturn() {
		this.delegatedTest(1);
	}
	...
	@Test
	public void generateListOfTiles_i_nodoInLoop_nodoInLoop() {
		this.delegatedTest(2);
	}
